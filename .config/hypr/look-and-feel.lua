...
hl.animation({ leaf = "fadeIn", enabled = true, speed = 1.39, bezier = "quick" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 1.46, bezier = "quick" })
hl.animation({ leaf = "fade", enabled = true, speed = 1.39, bezier = "quick" })
hl.animation({ leaf = "layers", enabled = true, speed = 1.39, bezier = "quick" })
...
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 1.39, bezier = "quick" })
